    ...
    /*
     ...
     /*       }                                                                                                 //
        ...
        */
        ...
        $('#form_crear-rol').on('submit', function(e) {                                                                            //
            e.preventDefault();
                                                                                                             //
                    ...
                    success: function(data) {       //cuando la llamada sea exitosa, el archivo definido en action devuelve TRUE o FALSE
                        ...
                        if( data == true) {     //Mostrará notificacion de INSERCION EXITOSA
                            Swal.fire({
                                ...
                                html: '<p class="sweetalert2-html-wellcomeText">¡Operacion EXITOSA!</p> <p class="sweetalert2-html-actionText">Creaste un nuevo rol</p>',
                            ...
                            setTimeout( function() {
                                window.location.href = 'crear-rol.php'; //luego de redirigir, se actualiza
                            }, 3000);// Se esperará cierto tiempo antes de ejecutarse
        
        
                        } else {        ////Mostrará notificacion de OPERACION FALLIDA
                            Swal.fire({
                                icon: 'error',            //muestra animacion de cruz
                                showConfirmButton: false,   //NO muestra boton de confirmar
